...
export function generateMetadata({ params }: { params: { category: string } }): Metadata {
  ...
  return blogCategoryMetadata("uz", params.category as BlogCategory);
}

export default function BlogCategoryUz({ params }: { params: { category: string } }) {
  if (!BLOG_CATEGORIES.includes(params.category as BlogCategory)) notFound();
  return <BlogCategoryIndex category={params.category as BlogCategory} locale="uz" />;
}
