...
export const SEO_KEYWORD_LAST_MODIFIED = "2026-06-25";
...
export const SEO_KEYWORD_CONFIG = {
  uz: {
    ...
    hardware: ["shtrix kod skaner kassa", "chek printer kassa", "kassa apparatsiz savdo"],
...
const uzScannerRelated = [
  { label: "Do'kon kassa", href: "/uz/dokon-kassa" },
  { label: "Telefon kassa", href: "/uz/telefon-kassa" },
  { label: "Ombor dasturi", href: "/uz/ombor-dasturi" },
  { label: "Kunlik tushum", href: "/uz/kunlik-tushum" },
];

const uzRevenueRelated = [
  { label: "Do'kon uchun programma", href: "/uz/dokon-uchun-programma" },
  { label: "Do'kon kassa", href: "/uz/dokon-kassa" },
  { label: "Ombor dasturi", href: "/uz/ombor-dasturi" },
  { label: "Shtrix kod skaner kassa", href: "/uz/shtrix-kod-kassa" },
];

const uzScannerProblems: SeoProblem[] = [
  {
    title: "Tovarni qo'lda qidirish sekin",
    problem: "Kassir nomi bo'yicha tovarni izlasa, navbat sekinlashadi va xato narx urilishi mumkin.",
    solution: "Shtrix kod skaner yoki telefon kamerasi tovarni darrov topadi va to'g'ri narxni qo'yadi.",
  },
  {
    title: "Chek yozish bosh og'rig'i bo'lib qoladi",
    problem: "Qo'lda yozilgan chek vaqt oladi va mijoz uchun ishonchli ko'rinmaydi.",
    solution: "Chek telefonda tayyorlanadi, kerak bo'lsa kichik chek printeriga chiqariladi.",
  },
  {
    title: "Kassa apparati shart kabi tuyuladi",
    problem: "Do'kon egasi katta kassa apparatisiz savdoni boshlay olmasligini o'ylaydi.",
    solution: "BirLiy bilan oddiy telefon yetadi, skaner va printer keyin va ixtiyoriy qo'shiladi.",
  },
];

const uzScannerFaq: SeoFaq[] = [
  { q: "Shtrix kod skanerni BirLiy bilan ulasa bo'ladimi?", a: "Ha. USB yoki Bluetooth skaner ulanadi. Boshlashda esa telefon kamerasi shtrix kodni o'qishi mumkin." },
  { q: "Chek printer kassa uchun majburiymi?", a: "Yo'q. Chekni telefonda ko'rsatish yoki ulashish mumkin. Kichik chek printeri faqat qog'oz chek kerak bo'lsa qo'shiladi." },
  { q: "Kassa apparatsiz savdo qilsa bo'ladimi?", a: "Ha. BirLiy telefonda kassa vazifasini bajaradi, shuning uchun katta kassa apparati shart emas." },
  { q: "Telefon bilan chek chiqarish qanday ishlaydi?", a: "Sotuv tugagach chek telefonda tayyor bo'ladi. Uni ko'rsatish, yuborish yoki chek printeriga chiqarish mumkin." },
  { q: "Skaner va printer qachon kerak bo'ladi?", a: "Tovar ko'p va navbat tez bo'lsa, skaner sotuvni tezlashtiradi. Qog'oz chek so'ralganda chek printeri qulay bo'ladi." },
  { q: "Shtrixkod skaner narxi BirLiy narxiga kiradimi?", a: "Yo'q. BirLiy obunasi alohida, jihozni do'kon o'ziga qulay vaqtda oladi. Obuna birinchi 6 oy 49 000 sum/oy." },
];

const uzRevenueProblems: SeoProblem[] = [
  {
    title: "Kunlik tushumni hisoblash qiyin",
    problem: "Naqd, karta, QR va nasiya alohida bo'lsa, kun oxirida tushumni qo'lda yig'ish kerak.",
    solution: "BirLiy har sotuvni hisobga oladi va kunlik tushumni avtomatik ko'rsatadi.",
  },
  {
    title: "Kassirni nazorat qilish noqulay",
    problem: "Egasi kassir qancha sotgani va kassada qancha pul borligini qo'ng'iroq qilib so'raydi.",
    solution: "Har kassir PIN bilan ishlaydi, egasi smena va harakatlarni telefonidan ko'radi.",
  },
  {
    title: "Do'kon egasi joyda bo'lmasa savdo ko'rinmaydi",
    problem: "Egasi do'konda bo'lmaganda kunlik savdoni faqat kechqurun biladi.",
    solution: "Egasi paneli tushum, qoldiq va kassirni istalgan joydan telefonda ko'rsatadi.",
  },
];

const uzRevenueFaq: SeoFaq[] = [
  { q: "Kunlik tushumni qanday hisoblayman?", a: "Sotuvlar BirLiyda yuritilsa, kunlik tushum avtomatik yig'iladi. Naqd, karta, QR va nasiya bitta hisobotda ko'rinadi." },
  { q: "Kassirni telefondan nazorat qilsa bo'ladimi?", a: "Ha. Egasi har kassir smenasini, sotuvini va kassa harakatlarini telefonidan ko'radi." },
  { q: "Do'kon tushumi va magazin tushumi bir narsami?", a: "Ha. Qidiruvda turlicha yozilsa ham maqsad bitta: do'kon kunlik savdosini aniq ko'rish." },
  { q: "Bir nechta kassir bo'lsa tushum aralashmaydimi?", a: "Yo'q. Har kassir alohida PIN bilan ishlaydi, shuning uchun kim qancha sotgani ajralib turadi." },
  { q: "Do'kon egasi uchun programma deyilganda nima nazarda tutiladi?", a: "Bu egaga tushum, qoldiq va kassir nazoratini bitta joyda beradigan dastur. BirLiy aynan shuni qiladi." },
  { q: "BirLiy narxi qancha?", a: "Birinchi 6 oy 49 000 sum/oy, keyin 149 000 sum/oy. Narx oldindan ma'lum." },
];
...
export const SEO_KEYWORD_PAGES = [
  {
    ...
    keywords: [
      ...
      "dokonga programma",
      "dokon pragramma",
      "dokon uchun pragramma",
      "dokon uchun dastur",
      "dokon dasturi",
      "dukon uchun programma",
      "dukon dasturi",
      ...
      "kasa programma",
      "docon programma",
      "докон учун программа",
      "дўкон учун программа",
      "докон программа",
      "савдо программа",
      "савдо дастури",
    ],
  },
  {
    ...
    helper: {
      ...
      body: "'Dokonga kassa', 'dukon kassa', 'qr tolov kassa' yoki 'karta tolov kassa' deb qidirsangiz ham, savol bir xil: kichik do'konga naqd, karta va QR to'lovni bitta hisobda yig'adigan sodda kassa kerak.",
    },
    faq: uzKassaFaq,
    finalCta: uzFinalCta,
    related: baseUzRelated,
    keywords: [
      ...
      "karta orqali tolov",
      "naqd va karta hisob",
      "naqd karta qarz hisob",
      "tolovlarni hisoblash",
      "dokon tolov hisobi",
      "magazin tolov hisobi",
      "qr тўлов касса",
      "кюар тўлов магазин",
    ],
  },
  ...
  },
  {
    ...
    keywords: [
      ...
      "qarzdorlar ro'yxati",
      "qarzdorlar royxati",
      "elektron qarz daftar",
      "elektron nasiya daftar",
      "qarz davtar",
      "karz davtar",
      "nasiya davtar",
      "nasya davtar",
  ...
  },
  {
    ...
    keywords: [
      "ombor dasturi",
      "ombor hisob dasturi",
      "ombor hisoblash programma",
      "sklad programma",
      "sklad dasturi",
      "tovar hisoblash programma",
      "tovar hisobi programma",
      "tovar qoldiq programma",
      "tovar qoldiqni korish",
      "tovar xisobi",
      "tovarni hisoblash",
      "dokon qoldiqni korish",
      "magazin qoldiq programma",
      "kirim chiqim programma",
      "dokon kirim chiqim",
      "magazin kirim chiqim",
      "tovar kirim chiqim",
      "sklad pragramma",
      "ombor pragramma",
      "tavar xisob",
  ...
  },
  {
    ...
    keywords: [
      ...
      "kassa telefonda",
      "kompyutersiz kassa",
      "kompyuter kerak emas kassa",
      "oddiy telefon bilan kassa",
      "telifonda kassa",
      "telefon pragramma",
      "касса телефонда",
      "телефон касса",
  ...
  },
  {
    ...
    keywords: [
      ...
      "магазинная программа",
      "программа для минимаркета",
      "программа для продуктового магазина",
      "программа для маленького магазина",
      "программа для небольшого магазина",
      "программа для магазина узбекистан",
      "товарный учет для магазина",
      "учет товара в магазине",
      "складской учет для магазина",
      "программа склад магазин",
      "учет остатков в магазине",
      "учет продаж магазин",
      "товарный учет узбекистан",
    ],
  },
  {
    locale: "ru",
    ...
    keywords: [
      ...
      "касса с qr оплатой",
      "кассовая программа для магазина",
      "касса для продуктового магазина",
      "касса для маленького магазина",
      "касса для магазина узбекистан",
      "qr оплата магазин",
      "оплата qr в магазине",
      "учет выручки магазин",
      "контроль кассира магазин",
    ],
  },
  {
    ...
    related: baseRuRelated,
    keywords: [
      "учет долгов в магазине",
      "программа для учета долгов",
      "долговая тетрадь магазин",
      "насия программа",
      "учет долгов клиентов",
      "электронная тетрадь долгов",
      "программа для насии",
      "учет рассрочки магазин",
    ],
  },
  {
    locale: "uz",
    slug: "shtrix-kod-kassa",
    path: "/uz/shtrix-kod-kassa",
    mainKeyword: "shtrix kod skaner kassa",
    eyebrow: "Skaner va chek printeri",
    h1: "Shtrix kod skaner kassa: telefon, skaner va chek bitta oqimda",
    intro: "BirLiy bilan shtrix kod skaner va chek printerini telefondagi kassaga ulaysiz. Boshlash uchun esa oddiy telefon kamerasi yetadi.",
    title: "Shtrix kod skaner kassa: telefon, skaner va chek bitta oqimda",
    description: "Shtrix kod skaner kassa va chek printer kassa izlayapsizmi? BirLiy telefonda kassa beradi, skaner va printer keyin ulanadi. Kassa apparatsiz savdo mumkin.",
    ogTitle: "Shtrix kod skaner kassa, BirLiy telefon bilan",
    ogDescription: "Skaner, chek printeri va telefon kassa bitta oqimda. Kassa apparati shart emas.",
    problems: uzScannerProblems,
    steps: uzSteps,
    features: uzFeatures,
    price: uzPrice,
    helper: {
      title: "Skaner, printer va apparat haqida qidiruvlar",
      body: "'Shtrix kod programma', 'shtrixkod skaner', 'chek printer kassa', 'kassa apparatsiz savdo' yoki 'kassa aparat kerakmas' deb qidirsangiz ham javob bitta: telefon bilan boshlab, jihozni keyin qo'shasiz.",
    },
    faq: uzScannerFaq,
    finalCta: uzFinalCta,
    related: uzScannerRelated,
    keywords: [
      "shtrix kod skaner kassa",
      "shtrix kod programma",
      "shtrix kod skaner programma",
      "shtrixkod programma",
      "shtrixkod skaner",
      "barcode skaner kassa",
      "skaner bilan kassa",
      "printer bilan kassa",
      "chek chiqarish programma",
      "chek printer kassa",
      "telefon bilan chek chiqarish",
      "kassa apparatsiz savdo",
      "kassa apparat kerakmi",
      "shtrixkot programma",
      "shtrih kod programma",
      "chek pragramma",
      "kassa aparatsiz",
      "kassa aparat kerakmas",
    ],
  },
  {
    locale: "uz",
    slug: "kunlik-tushum",
    path: "/uz/kunlik-tushum",
    mainKeyword: "kunlik tushum hisoblash",
    eyebrow: "Egasi nazorati uchun",
    h1: "Kunlik tushum hisoblash va kassir nazorati telefonda",
    intro: "BirLiy do'kon kunlik tushumini avtomatik yig'adi. Egasi joyda bo'lmasa ham kassir, savdo va qoldiqni telefonidan ko'radi.",
    title: "Kunlik tushum hisoblash va kassir nazorati telefonda",
    description: "Kunlik tushum hisoblash, dokon tushumi va kassir nazorati uchun BirLiy. Naqd, karta, QR va nasiya bitta hisobotda, egasi paneli telefonda.",
    ogTitle: "Kunlik tushum hisoblash va kassir nazorati, BirLiy",
    ogDescription: "Do'kon tushumi, kassir nazorati va qoldiq egasi telefonida ko'rinadi.",
    problems: uzRevenueProblems,
    steps: uzSteps,
    features: uzFeatures,
    price: uzPrice,
    helper: {
      title: "Tushum va kassir nazorati haqida qidiruvlar",
      body: "'Dokon tushumi', 'magazin tushumi', 'tushumni korish', 'kassir nazorat' yoki 'dokon egasi uchun programma' deb qidirsangiz ham, maqsad bir xil: savdoni va kassirni aniq ko'rish.",
    },
    faq: uzRevenueFaq,
    finalCta: uzFinalCta,
    related: uzRevenueRelated,
    keywords: [
      "kunlik tushum hisoblash",
      "dokon tushumi",
      "magazin tushumi",
      "tushumni korish",
      "kassir nazorat",
      "kassirni nazorat qilish",
      "dokon egasi uchun programma",
      "magazin egasi uchun programma",
      "dokon hisobi",
      "savdo hisobi",
      "sotuv hisobi",
      "magazin tushumi hisoblash",
    ],
  },
