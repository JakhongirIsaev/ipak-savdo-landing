...
const ru = {
  ...
  formNeedsEquipment: "Нужен комплект: планшет, сканер и чековый принтер",
  ...
  formSecurity: "Доступ по PIN, разделение ролей и полный журнал действий. Данные используем только для подключения.",
...
const uz: typeof ru = {
  ...
  formNeedsEquipment: "Menga jihoz kerak: planshet, skaner va chek printeri",
  ...
  formSecurity: "PIN orqali kirish, rollar va to'liq harakatlar jurnali. Ma'lumotlar faqat ulash uchun ishlatiladi.",
