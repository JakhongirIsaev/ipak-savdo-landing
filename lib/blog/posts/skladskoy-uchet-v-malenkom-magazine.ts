...
export const post: BlogPost = {
  ...
  date: "2026-06-24",
  modified: "2026-06-24",
  image: { square: "https://birliy.uz/photos/blog/skladskoy-uchet-v-malenkom-magazine-1x1.jpg", landscape: "https://birliy.uz/photos/blog/skladskoy-uchet-v-malenkom-magazine-4x3.jpg", wide: "https://birliy.uz/photos/blog/skladskoy-uchet-v-malenkom-magazine-16x9.jpg" },
  locales: {
    uz: {
      title: "Do'konda qoldiq hisobi: tovarni yo'qotmaslikning oddiy usuli",
      description:
        "Kichik do'konlarda qoldiq hisobi qanday olib boriladi? Daftardagi xatolar, unutilgan nasiya va kamomadni oldini olish uchun amaliy maslahatlar. BirLiy bilan tanishib chiqing.",
      keywords: [
        "do'konda qoldiq hisobi",
        "tovar yo'qotish",
        "ombor hisobi usuli",
      ...
      intro: [
        "Har kuni do'konga yuzlab mahsulot keladi, sotiladi va yana qayta buyurtma beriladi. Agar siz qoldiqni daftarga yozsangiz, bir haftada sahifalar chalkashib ketadi. Tovarlar yo'qoladi, ayrimlari muddati o'tib qoladi, nasiya unutiladi.",
        "Muammo shundaki, ko'p kichik do'konlarda raqamli hisob yo'q. Daftar bilan ishlash xato va vaqt talab qiladi. Ammo bugun smartfon yordamida buni tuzatish mumkin.",
      ],
      sections: [
        {
          ...
          list: [
            "Bir mahsulot ikki marta yoziladi",
            "Xaridor nasiya pullarini unutadi",
            "Kechqurun hisobda farq chiqadi",
            "Muddati o'tgan tovar sotilishicha qoladi",
          ],
        },
        {
        ...
        },
        {
          ...
          list: [
            "Har bir sotuv yozib boriladi",
            "Nasiya alohida ko'rinadi",
            "Qoldiq to'g'risida ogohlantirish",
          ],
        },
        {
          h2: "BirLiy bilan boshlash qanday?",
          paragraphs: [
            "Hozirgi kunda BirLiy erta kirish rejimida ishlaydi. Toshkentdagi birinchi do'konlar bilan sinov bosqichi o'tmoqda. Ro'yxatdan o'tish uchun sizga patent, pasport va do'kon surati kerak.",
            "Agar siz kichik do'koningizda qoldiq hisobini tartibga solmoqchi bo'lsangiz, biz bilan bog'laning. Sizga qanday ishlashini ko'rsatamiz.",
          ],
        },
      ],
      faq: [
        {
          q: "Barcha mahsulotlarni qayta kiritish kerakmi?",
          a: "Ha, dastlabki ro'yxatni yaratishingiz kerak. Lekin keyin har bir yangi tovarni qo'shish bir necha soniya oladi.",
        },
        {
        ...
        },
        {
          ...
          a: "Ha, nasiya qilingan mahsulotlar maxsus bo'limda saqlanadi va to'lov qilinganida avtomatik o'chiriladi.",
        },
        {
          q: "Kun oxirida hisobni necha kunda ko'raman?",
          a: "Har kuni so'nggi savdodan keyin avtomatik hisobot tayyor bo'ladi.",
        },
        {
          q: "Daftarni butunlay tashlasak bo'ladimi?",
          a: "Ha, barcha ma'lumotlar telefonda saqlanadi. Ehtiyot uchun zaxira nusxa olishni unutmang.",
        },
      ],
      cta: { text: "Do'koningizda raqamli hisobni sinab ko'rmoqchimisiz? Biz bilan bog'laning va qanday ishlashini ko'rsatamiz.", button: "BirLiy.uz ga o'ting" },
    },
    ru: {
      ...
      sections: [
        {
          ...
          list: [
            ...
            "Долги покупателей теряются или забываются",
            "Сложно понять, какой товар закончился",
        ...
        },
        {
          ...
          list: [
            ...
            "Быстрый заказ поставщику",
            "Уверенность, что каждый сум учтён",
          ],
        },
        {
          h2: "Как попробовать BirLiy?",
          paragraphs: [
            "Сейчас проект на стадии раннего доступа: первые магазины в Ташкенте уже тестируют систему, но мы открыты для заявок. Для подключения нужны три фото: патент, паспорт владельца и витрина магазина.",
            "Если хотите навести порядок в учёте и перестать терять товар, напишите нам. Покажем, как работает приложение, и поможем настроить.",
          ],
        },
      ],
      faq: [
        {
          q: "Нужно ли вводить все товары вручную?",
          a: "Да, сначала нужно создать каталог. Но потом новый товар добавляется за несколько секунд.",
        },
        {
          q: "Подойдёт ли старый телефон?",
          a: "Да, приложение работает на большинстве современных смартфонов. Нужен только интернет.",
        },
        {
          q: "Как учитываются долги?",
          a: "Долг записывается отдельно, при оплате автоматически помечается как погашенный.",
        },
        {
          q: "Можно ли посмотреть отчёт за неделю?",
          a: "Да, в приложении есть история продаж и остатков за любой период.",
        },
        {
    ...
    en: {
      ...
      keywords: [
        ...
        "how not to lose goods",
        "phone POS for shop",
        "neighbourhood shop accounting",
        "debt notebook replacement",
        "BirLiy",
      ],
      intro: [
      ...
      sections: [
        {
          ...
          list: [
            ...
            "Customer debts disappear or are forgotten",
            "Hard to know which product is running low",
            "Expired goods are discovered too late",
          ],
        },
        {
        ...
        },
        {
          ...
          list: [
            "Save on write-offs of expired goods",
            "Order from suppliers faster",
            "Be confident every som is accounted for",
          ],
        },
        {
          h2: "How to try BirLiy",
          paragraphs: [
            "The project is now in early access: the first shops in Tashkent are testing it, but we are open for applications. To start, you need three photos: your patent, the owner's passport, and the shop window.",
            "If you want to bring order to your inventory and stop losing goods, write to us. We'll show you how the app works and help you set it up.",
          ],
        },
      ],
      faq: [
        {
          q: "Do I have to enter all products manually?",
          a: "Yes, you create the catalogue first. But adding a new product takes just a few seconds.",
        },
        {
          q: "Will it work on an old phone?",
          a: "Yes, the app works on most modern smartphones. You only need internet.",
        },
        {
          q: "How are debts tracked?",
          a: "Debts are recorded separately, and when paid, they're automatically marked as settled.",
        },
        {
          q: "Can I see a weekly report?",
          a: "Yes, the app shows sales and stock history for any period.",
        },
        {
