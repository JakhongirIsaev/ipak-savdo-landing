...
import { X, Send, ChevronDown, ChevronUp, CheckCircle2 } from "lucide-react";
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white border-b border-card-border px-6 py-4 flex items-center justify-between rounded-t-2xl z-10">
              <h3 className="text-lg font-bold text-text-dark">{t.modalTitle}</h3>
              <button
                onClick={onClose}
                className="p-2 hover:bg-soft-green-bg rounded-lg transition-colors"
              >
            ...
            <div className="p-6">
              {submitted ? (
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-text-dark mb-2">{t.formSuccess}</h4>
                </motion.div>
              ) : (
